...
function MoviesCardList() {
  ...
  return (
    <div className="movies-cardlist">
      ...
      <MoviesCard imageUrl={moviesData[3].imageUrl} title={moviesData[3].title} duration={moviesData[3].duration} isLiked={moviesData[3].isLiked} onLikeClick={moviesData[3].onLikeClick} />
      <MoviesCard imageUrl={moviesData[4].imageUrl} title={moviesData[4].title} duration={moviesData[4].duration} isLiked={moviesData[4].isLiked} onLikeClick={moviesData[4].onLikeClick} />
      <MoviesCard imageUrl={moviesData[5].imageUrl}title={moviesData[5].title} duration={moviesData[5].duration} isLiked={moviesData[5].isLiked} onLikeClick={moviesData[5].onLikeClick} />
      <MoviesCard imageUrl={moviesData[6].imageUrl} title={moviesData[6].title} duration={moviesData[6].duration} isLiked={moviesData[6].isLiked} onLikeClick={moviesData[6].onLikeClick} />
      <MoviesCard imageUrl={moviesData[7].imageUrl} title={moviesData[7].title} duration={moviesData[7].duration} isLiked={moviesData[7].isLiked} onLikeClick={moviesData[7].onLikeClick} />
      <MoviesCard imageUrl={moviesData[8].imageUrl}title={moviesData[8].title} duration={moviesData[8].duration} isLiked={moviesData[8].isLiked} onLikeClick={moviesData[8].onLikeClick} />
